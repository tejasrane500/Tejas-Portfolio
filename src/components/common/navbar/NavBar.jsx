    ...
    >
      <div className="navbar flex justify-between mx-auto content">
        <div className="flex items-center justify-between">
          ...
          >
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/dc/Eo_circle_purple_letter-t.svg/1200px-Eo_circle_purple_letter-t.svg.png" className="h-8 sm:h-14 rounded-2xl" alt="logo" />
